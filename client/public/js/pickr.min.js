    ...
    return function(t) {
        ...
        function u(t, e=(t => t)) {
            function o(o) {
                ...
                let i = 0
                  , r = t.selectionStart;
                t.value = t.value.replace(/[\d.]+/g, (t, o) => o <= r && o + t.length >= r ? (r = o,
                e(Number(t), n, i)) : (i++,
                t)),
                t.focus(),
            ...
            const i = (t, e) => (o=-1) => e(~o ? t.map(t => Number(t.toFixed(o))) : t)
              , r = {
                ...
                toHSVA() {
                    ...
                    return t.toString = i(t, t => `hsva(${t[0]}, ${t[1]}%, ${t[2]}%, ${r.a})`),
                    t
                },
                toHSLA() {
                    const t = [...b(r.h, r.s, r.v), r.a];
                    return t.toString = i(t, t => `hsla(${t[0]}, ${t[1]}%, ${t[2]}%, ${r.a})`),
                    t
                },
                toRGBA() {
                    const t = [...v(r.h, r.s, r.v), r.a];
                    return t.toString = i(t, t => `rgba(${t[0]}, ${t[1]}, ${t[2]}, ${r.a})`),
                    t
                },
                toCMYK() {
        ...
        function $(t) {
            const e = {
                ...
                _keyboard(t) {
                    ...
                    if (document.activeElement === o.wrapper) {
                        ...
                        if ("keydown" === n && (r || s || a || l)) {
                            let n = 0
                              , i = 0;
                            "v" === o ? n = r || s ? 1 : -1 : "h" === o ? n = r || s ? -1 : 1 : (i = r ? -1 : a ? 1 : 0,
                            n = l ? -1 : s ? 1 : 0),
                            e.update(k(e.cache.x + .01 * n), k(e.cache.y + .01 * i)),
                            t.preventDefault()
                        } else
                ...
                _tapmove(t) {
                    ...
                    if (t) {
                        ...
                        n && (l = n.x * a.width,
                        c = n.y * a.height);
                    "h" !== i && (r.style.left = `calc(${l / a.width * 100}% - ${r.offsetWidth / 2}px)`),
                    "v" !== i && (r.style.top = `calc(${c / a.height * 100}% - ${r.offsetHeight / 2}px)`),
                    e.cache = {
                        x: l / a.width,
                        y: c / a.height
                    };
            ...
            return r([o.wrapper, o.element], "mousedown", n),
        ...
        class x {
                  ...
                  , s = {
                    palette: $({
                        ...
                        onchange(o, n) {
                            ...
                            a.comparison ? a.useAsButton || t._lastColor || (l.style.color = p) : (s.button.style.color = p,
            ...
            _bindEvents() {
                const {_root: t, options: e} = this
                  , o = [r(t.interaction.clear, "click", () => this._clearColor()), r([t.interaction.cancel, t.preview.lastColor], "click", () => {
                    this._emit("cancel"),
            ...
            addSwatch(t) {
                ...
                if (e) {
                    const {_swatchColors: t, _root: o} = this
                      , n = C(...e)
                      , i = a(`<button type="button" style="color: ${n.toRGBA().toString(0)}" aria-label="${this._t("btn:swatch")}"/>`);
                    return o.swatches.appendChild(i),
                    t.push({
                        el: i,
                        color: n
                    }),
            ...
            applyColor(t=!1) {
                ...
                return e.lastColor.style.color = n,
            ...
            show() {
                return this.options.disabled || (this._root.app.classList.add("visible"),
