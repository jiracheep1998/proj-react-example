var _Path = SVG.Path,
    _PathArray = SVG.PathArray,
    _PointArray = SVG.PointArray,
...
_extend(_Path, {
    ...
    toPoly(sample = '1%', replace = true) {
        // define type
        const Poly = /z\s*$/i.test(this.attr('d')) ? _Polygon : _Polyline
